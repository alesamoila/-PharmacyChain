...
public class Medicament implements java.io.Serializable{
	...
	public Medicament(String nume, double pret, String disponibilitate, String valabilitate, String producator) {
		super();
		this.nume = nume;
		this.pret = (float) pret;
		this.disponibilitate =Integer.parseInt( disponibilitate);
